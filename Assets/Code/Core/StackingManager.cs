...
namespace TZ_24PLAY
{
    ...
    {
        public event Action<Vector3> OnNewStackable;
        public Action OnWallCollision;
        ...
        private const float DELAY_AFTER_COLLISION = 0.4f;
        private const float STACKING_SPEED = 5f;
        ...
        public void Add(CubePickup cubePickup)
        {
            ...
            OnNewStackable?.Invoke(new Vector3(cubePickup.transform.position.x, CurrentHeight(), cubePickup.transform.position.z));
        }
